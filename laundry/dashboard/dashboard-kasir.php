...
<body>
    <div class="content">
        <header>
            ...
            <div class="menu">
            <ul>
                <li><a href="dashboard-kasir.php?halaman=paket"><b>Paket</b></a></li>
                    <li><a href="dashboard-kasir.php?halaman=outlet"><b>Outlet</b></a></li>
                <li><a href="dashboard-kasir.php?halaman=transaksi"><b>Transaksi</b></a></li>
                <li><a href="dashboard-kasir.php?halaman=laporan"><b>Laporan</b></a></li>
            </ul>
        </div>
        </header>
        <div class="badan">
            ...
            if (isset($_GET['halaman'])){
                switch ($_GET['halaman']) {
                    case 'paket' :
                        ...
                        break;
                    case 'outlet' :
                        include "../outlet/outlet-kasir.php";
                        break;
                    case 'transaksi' :
