...
<head>
    ...
    <title>Dashboard - Kasir - Laundry.ku</title>
</head>
<style>
...
<body>
    <div class="content">
        <header>
            ...
            <div class="menu">
            <ul>
                <li><a href="dashboard-member.php?halaman=user"><b>Akun</b></a></li>
                <li><a href="dashboard-member.php?halaman=laporan"><b>Laporan</b></a></li>
            </ul>
        </div>
        </header>
        <div class="badan">
        ...
        <footer>
            ...
            <div class="col-3">
                <button type="submit" name="logout" onClick="out()">Logout</button>
                <script>
                    function out(){
